# PARTE 2: Symfony Framework, Docker y Arquitectura Hexagonal
...
│                                                                │
│  EXTERIOR (Infraestructura)    INTERIOR (Dominio)              │
│  ┌──────────────────────┐      ┌──────────────────────┐       │
│  │  HTTP (Controller)   │      │  Domain              │       │
│  │  Database (Repo)     │◀────▶│  - Billetera         │       │
│  │  MQ (Messenger)      │      │  - Dinero (VO)       │       │
│  └──────────────────────┘      │  - Moneda (Enum)     │       │
│                                │  - Movimiento (VO)   │       │
│                                └──────────────────────┘       │
│                                                                │
│  CONTROLADOR (Application Service)                             │
│  ┌──────────────────────┐                                      │
│  │ CrearBilleteraSvc    │  ← Orquesta dominio + infra         │
│  │ RealizarDepositoSvc  │    No contiene lógica de negocio    │
│  └──────────────────────┘                                      │
└────────────────────────────────────────────────────────────────┘
```
