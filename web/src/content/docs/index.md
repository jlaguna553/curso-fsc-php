...
{'<'}div class="hero-section">
  ...
  {'<'}p>{'<'}strong>5 partes{'<'}/strong> · {'<'}strong>48 lecciones{'<'}/strong> · {'<'}strong>50 ejercicios{'<'}/strong> · {'<'}strong>292 puntos{'<'}/strong>{'<'}/p>
{'<'}/div>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 0 — Infraestructura Base y Entorno de Desarrollo {'<'}span class="badge">27 pts{'<'}/span>{'<'}/h3>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 1 — PHP 8.3 Moderno, POO y DDD {'<'}span class="badge">57 pts{'<'}/span>{'<'}/h3>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 2 — Symfony y Arquitectura Hexagonal {'<'}span class="badge">52 pts{'<'}/span>{'<'}/h3>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 3 — CQRS y Event-Driven Architecture {'<'}span class="badge">52 pts{'<'}/span>{'<'}/h3>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 4 — Testing Profesional {'<'}span class="badge">52 pts{'<'}/span>{'<'}/h3>
...
{'<'}div class="part-card">
  {'<'}h3>Parte 5 — Observabilidad, Kubernetes y CI/CD {'<'}span class="badge">52 pts{'<'}/span>{'<'}/h3>
